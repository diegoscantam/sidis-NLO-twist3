...
C--   Find the zero of this function using DZEROX.
      ...
      IMPLICIT NONE
      INTEGER IORD
      DOUBLE PRECISION FR2, R0, ASI, MC, MB, MT, MUR, ASMUR, ALPHASWW
      COMMON / DZEROXcommon / FR2, MUR, ASMUR, MC, MB, MT, R0, IORD

      CALL INITALPHASR0(IORD, FR2, R0, ASI, MC, MB, MT)
      FINDALPHASR0 = ALPHASWW(MUR) - ASMUR ! solve equal to zero
...
C----------------------------------------------------------------------
      ...
      DOUBLE PRECISION FUNCTION ALPHASWW(MUR)
      IMPLICIT NONE
