...
\end{equation} 
where $\mathbb{B}(a,b)$ is the Euler beta function and $\xi$ is a generic fractional momentum variable. Based on this, we construct some simple models for the fragmentation functions of interest. We set
\begin{equation}
    \begin{aligned}
