...
! 
!         DO 10 i=0,49
!         X=10.d0**(-3.d0+3.d0*i/50)
!         Q2=10.0
!         CALL DSSVGUPDATE(X,Q2,DUV,DDV,DUBAR,DDBAR,DSTR,DGLU)
! c       (remember it gives x times the pdf) 
!         WRITE(6,100) X,DUV,DDV,DUBAR,DGLU
!  10     continue
!  100    FORMAT(7(F11.7))
! 
!         END
...
C                                                                            
C       REFERENCE:         Phys.Rev.Lett. 113 1  012001  (2014)                                                 
C                                                                            
C       INPUT:                                                               
...
*
      ...
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DIMENSION ARG(2),NENT(2),ENT(73),TABLE(1200) ! this line is modified not the original file
!       DIMENSION ARG(5),NENT(5),ENT(73),TABLE(1200) T this is the original dssv
