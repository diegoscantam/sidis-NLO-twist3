...
and
    \begin{equation}
        \begin{aligned}
            \mathcal{C}_{UT}^{q\to \bar{q}q}&=+\delta(1-w)\frac{(2  C_F-N_C) \left(\left(2 v^2-3 v+1\right) \log (Q^2/\mu^2)+\left(2 v^2-3 v+1\right) \log ((1-v) v)+\zeta  v\right)}{2 \zeta  ((\zeta -1) v+1)}\\
            &+\frac{\left(2 v^2-3 v+1\right) w^2 (2  C_F-N_C) \left((\zeta -1) \zeta  v^2+(\zeta -1) v ((2 \zeta -1) w-2 \zeta )+\zeta  (w-1) (\zeta  (w-1)+1)\right)}{2 (\zeta -1) \zeta  v (1-w)_+ (\zeta  (v-1)+(\zeta -1) w) ((\zeta -1) v+\zeta  (w-1)+1)}
        \end{aligned}
    \end{equation}
The LT ones bla bla bla
\begin{equation}
        \begin{aligned}
            \mathcal{C}_{UT}^{q\to qg}&=C_F \Big[\delta(1-w)\delta(1-v)\frac{\left(-15 \zeta +\log ^2(\zeta )-6 \log (\zeta )+2 (2 \zeta +\log (\zeta )-2) \log (Q^2/\mu^2)+15\right)}{2 (\zeta -1)}\\
            &+\delta(1-w)\frac{ \left(\left(\log (Q^2/\mu^2)+\log(1-v)+\log(v)\right) \left(\zeta +2 (\zeta -1) v^2-(\zeta -3) v-1\right)-2 \zeta  v^2+2 v^2-3 v+1\right)}{\zeta  (1-v)_+ }\\
