...
\begin{equation}
    \begin{aligned}
        P^H_{qqg}(v,\zeta)&= \dots\\
        P^H_{q\bar{q}q}(v,\zeta)&= \dots\\
        P^E_{qqg}(v,\zeta)&= \dots\\
        P^E_{q\bar{q}q}(v,\zeta)&= \dots,
    \end{aligned}
\end{equation}
